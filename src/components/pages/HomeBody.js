...
const IndexArea = () => {
  return(
    <React.Fragment>
      <section className="row d-flex flex-column-reverse home-intro">
    ...
    <React.Fragment>
      ...
      <section className="row m-t5 d-flex flex-column flex-sm-row align-items-center" id="pace-summary">
        <article className="col">
          ...
          <h3>Time Tracking</h3>
          <p>Easy time time tracking and monitoring process for day day to day activities and tasks. </p>
        </article>
        <article className="col">
          ...
          <h3>Report Sheet</h3>
          <p>Keep accountability for time and money spent on our report page</p>
        </article>
        <article className="col">
          ...
          <p>Assign and receive tasks and, make on tasks to suit your discomforts.</p>
        </article>
      </section>
      {/* row 2 */}
      <section className="row m-t5 d-flex flex-column flex-sm-row align-items-center" id="pace-summary">
        <article className="col">
          ...
          <h3>Calendar</h3>
          <p>Stay up to date and manage events and tasks on Pace calender</p>
        </article>
        <article className="col">
          ...
          <p>Cost your billings on an hourly employee work hour basis.</p>
        </article>
        <article className="col">
          ...
          <h3>Todo-List</h3>
          <p>Break down your task into smaller bits to increase work efficiency</p>
        </article>
      </section>
    </React.Fragment>
  )
    ...
    <React.Fragment>
      ...
      <section className="container">
        <div className="row block block-1">
          <article className="col d-flex flex-column-reverse" id="dashboard-display">
            <blockquote>
        ...
        <div className="row block block-2">
          <article className="col d-flex flex-column" id="dashboard-display">
            <img src={manageEmployee} alt=" pace dashboard " />
            <blockquote>  
