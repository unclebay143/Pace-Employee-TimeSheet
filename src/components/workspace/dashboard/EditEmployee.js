...
export default function EditEmployee() {
    ...
    const {firstname, lastname, salary, phone, email} = { employees }
    alert(employees)
                        ...
                        return(
                            <Form onSubmit={handleSubmit} className="container">
                                ...
                                <div className="col-md-12">
                                    <p onClick={()=>setShowPassword(!showPassword)} className="text-primary" style={{cursor: 'pointer'}}>{showPassword? "Show password" : "Hide Password"}</p>
                                </div>
