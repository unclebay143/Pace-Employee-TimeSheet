...
// Accepted Task
export const FETCH_ACCEPTED_TASKS_PENDING = 'FETCH_ACCEPTED_TASKS_PENDING';
export const FETCH_ACCEPTED_TASKS_SUCCESS = 'FETCH_ACCEPTED_TASKS_SUCCESS';
export const FETCH_ACCEPTED_TASKS_ERROR = 'FETCH_ACCEPTED_TASKS_ERROR';
export const DELETE_ACCEPTED_TASK = 'DELETE_ACCEPTED_TASK';
...
//E-SCHEDULE
export const FETCH_ESCHEDULE_EVENT_SUCCESSFUL = 'FETCH_ESCHEDULE_EVENT_SUCCESSFUL';
export const FETCH_ESCHEDULE_ERROR = 'FETCH_ESCHEDULE_ERROR';
export const ADD_NEW_ESCHEDULE_EVENT = 'ADD_NEW_ESCHEDULE_EVENT';
export const DELETE_ESCHEDULE_EVENT_SUCCESSFUL = 'DELETE_EVENT_SUCCESSFUL';
export const EDIT_ESCHEDULE_EVENT = 'EDIT_ESCHEDULE_EVENT';
